...
import frc.robot.CommandGroups.GroundPickUpball;
...
public class OI 
{
  ...
  public OI()
  {
    ...
    groundBall.whenPressed(new GroundPickUpball(0, 115000));
   // groundBall2.whenPressed(new PIDElevatorWrist(0, 95000));
    groundBall3.whenPressed(new GroundPickUpball(0, 85000));
