...
public class OI 
{
  ...
  //Operator
  public Button linearActuatorUp = new JoystickButton(Operator, 3);  //3
  public Button linearActuatorDown = new JoystickButton(Operator, 2);  //2

  public Button climbingWheel = new JoystickButton(Operator, 5);  //5
  public Button climbingWheelReverse  = new JoystickButton(Operator, 6);  //6

  public Button releaseClimbingClaw = new JoystickButton(Operator, 7); //7
  public Button attachClimbingClaw = new JoystickButton(Operator, 8);  //8
