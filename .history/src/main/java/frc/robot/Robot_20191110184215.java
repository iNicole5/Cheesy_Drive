...
public class Robot extends TimedRobot {
  public static CheesyDrive m_subsystem = new CheesyDrive();
  ...
  public void robotInit() {
    ...
    DifferentialDrive cheesyDrive;
    DifferentialDrive cheesyDrive2 = cheesyDrive;
    cheesyDrive = new DifferentialDrive(leftDriveBase, rightDriveBase);
  ...
  public void teleopPeriodic() {
    Scheduler.getInstance().run();
    cheesyDrive.curvatureDrive(Robot.oi.Driver.getRawAxis(1), Robot.oi.Driver.getRawAxis(4), true);
  }
