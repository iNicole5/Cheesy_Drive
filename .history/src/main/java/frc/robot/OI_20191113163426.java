...
public class OI 
{
  ...
  public Button cargoShipBall = new JoystickButton(ButtonPannel, 11); 
  ...
  public OI()
  {
    ballLevel1.whenPressed(new PIDElevatorAuto(0,31769));     //wristLevel1
    ballLevel2.whenPressed(new PIDElevatorAuto(134639, 6560)); //wristLevel2
    ballLevel3.whenPressed(new PIDElevatorAuto(317128, 7487));  //wristLevel3

   // breakRelease.whenPressed(new cmdBreakOff());
   // breakeEngage.whenPressed(new cmdBreakOn());

    hatchLevel1.whenPressed(new PIDElevatorAuto(0, 0));        ////PIDElevatorBreak  
    hatchLevel2.whenPressed(new PIDElevatorAuto(203160, 0));   //PIDElevatorBreak    257222    
    hatchLevel3.whenPressed(new PIDElevatorAuto(384299, 0));    //424658   //384299

    cargoShipBall.whenPressed(new PIDElevatorAuto(34203, 16760));
    //groundBall.whenPressed(new PIDElevatorAuto(0, 110000));
    //groundBall2.whenPressed(new PIDElevatorAuto(0, 95000));
    //groundBall3.whenPressed(new PIDElevatorAuto(0, 85000));
    humanPlayerStationHatch.whenPressed(new PIDElevatorAuto(38522, 28996)); //35960   //79124
