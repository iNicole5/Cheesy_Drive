...
{
  public WPI_tall wristMotor = new WPI_TalonSRX(RobotMap.wristMotor);
  ...
  public void periodic() 
  {
    ...
    if ((Math.abs(Robot.oi.Operator.getRawAxis(0)) > 0.1) && (PIDModeWrist))
    {
      PIDModeWrist = false;
  ...
  {
    wristMotor.set(joystick.getRawAxis(0));
  }
