...
public class Wrist extends Subsystem {
  //public Joystick Operator = new Joystick(1); //Operator 1
  ...
  public void periodic() 
  {
    ...
    if ((Math.abs(Robot.oi.Operator.getRawAxis(1)) > 0.1) && (PIDmodeWrist))
    {
      PIDmodeWrist = false;
...
/*
  ...
  {
    if (getWristEncoder() == 0 || getWristEncoder() == 106000)
    {
      stop();
    }
  }
